...
const AddEditUser = ({ fetchUsers }) => {
  ...
  return (
    <div>
      <h2 className="text-xl font-bold mb-2"> {id ? 'Edit' : 'Add'} Users</h2>
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <button
            type="submit"className="bg-black text-white hover:bg-white hover:text-black font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
>
            Save
          </button>
        </div>
